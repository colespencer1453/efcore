...
public interface IConventionStoredProcedureParameterBuilder : IConventionAnnotatableBuilder
{
    ...
    IConventionStoredProcedureParameterBuilder? HasStoreType(string? storeType, bool fromDataAnnotation = false);
    ...
    /// <param name="fromDataAnnotation">Indicates whether the configuration was specified using a data annotation.</param>
    /// <returns>The same builder instance if the configuration was applied; <see langword="null" /> otherwise.</returns>
    IConventionStoredProcedureParameterBuilder? HasTypeMapping(
