...
/// <remarks>
///     <para>
///         Provides a simple API for configuring a <see cref="StoredProcedureParameter" />.
///     </para>
///     <para>
...
///     </para>
/// </remarks>
public class InternalStoredProcedureParameterBuilder : AnnotatableBuilder<StoredProcedureParameter, IConventionModelBuilder>,
    IConventionStoredProcedureParameterBuilder
{
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    public virtual IConventionStoredProcedureParameterBuilder? HasStoreType(
        string? storeType,
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    public virtual IConventionStoredProcedureParameterBuilder? HasTypeMapping(
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    public virtual IConventionStoredProcedureParameterBuilder? PropagatesNullability(
    ...
    /// <inheritdoc />
    [DebuggerStepThrough]
    IConventionStoredProcedureParameterBuilder? IConventionStoredProcedureParameterBuilder.HasStoreType(
        string? storeType,
    ...
    /// <inheritdoc />
    [DebuggerStepThrough]
    bool IConventionStoredProcedureParameterBuilder.CanSetStoreType(string? storeType, bool fromDataAnnotation)
        => CanSetStoreType(storeType, fromDataAnnotation ? ConfigurationSource.DataAnnotation : ConfigurationSource.Convention);

    /// <inheritdoc />
    [DebuggerStepThrough]
    IConventionStoredProcedureParameterBuilder? IConventionStoredProcedureParameterBuilder.HasTypeMapping(
        RelationalTypeMapping? typeMapping,
        bool fromDataAnnotation)
    ...
    /// <inheritdoc />
    [DebuggerStepThrough]
    bool IConventionStoredProcedureParameterBuilder.CanSetTypeMapping(RelationalTypeMapping? typeMapping, bool fromDataAnnotation)
